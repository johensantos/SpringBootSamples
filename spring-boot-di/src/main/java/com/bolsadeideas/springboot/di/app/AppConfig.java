...
import com.bolsadeideas.springboot.di.app.models.service.MiServicioComplejo;
 ...
 //CONFIGURANDO LOS BEANS(COMPENTS O SERVICES MANUALMENTE)
@Configuration
public class AppConfig {

	@Bean("miServicioSimple")//le das el nombre
	public IServicio registrarMiServicio() {
		
		return new MiServicio();
		
	}
	//@Primary tambien se puede predeterminar con primary
	@Bean("miServicioComplejo")//le das el nombre
